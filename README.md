This project is designed to show my comment regimen using variable name prefixes to denote the type and make it east to access variables by type through autocomplete. 
